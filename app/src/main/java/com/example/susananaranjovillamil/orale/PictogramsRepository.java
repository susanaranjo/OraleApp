...
public class PictogramsRepository {
    ...
    private PictogramsRepository () {
        ...
        pictograms.add(new Pictogram("p29","p29","p29",R.drawable.p29, year,month,day,"chûte",""));
        pictograms.add(new Pictogram("p30","p30","p30",R.drawable.p30, year,month,day,"contraceptives",""));
        pictograms.add(new Pictogram("p31","p31","p31",R.drawable.p31, year,month,day,"chaud",""));
        pictograms.add(new Pictogram("p32","p32","p32",R.drawable.p32, year,month,day,"voyage",""));
        pictograms.add(new Pictogram("p43","p43","p43",R.drawable.p43, year,month,day,"soulèvement de charge",""));
        pictograms.add(new Pictogram("p51","p51","p51",R.drawable.p51, year,month,day,"grossesse",""));
